          ...
          <div className='max-w-[450px] mx-auto px-3 mt-5'>
            ...
            <div className='flex w-full justify-between items-start'>
              <div className='flex items-center gap-3 mb-8'>
                <div className='w-[70px] h-[70px] flex justify-center items-center bg-[#135e26] text-white rounded-[50%]'>
                  <h2 className='text-4xl font-medium'> {userData.username.slice(0, 1)}</h2>
                </div>
                <div>
              ...
              <button className='pr-2' onClick={() => setsettingsIsOpen(!settingsIsOpen)}>
            ...
            {settingsIsOpen && <div className='w-full h-screen fixed z-40 bg-black opacity-40 top-0  left-0' onClick={() => { setsettingsIsOpen(false), setconfirmModalIsOpen(false) }}></div>}

            <div className='max-w-[450px] mx-auto relative'>
              <div className='w-full h-full bg-white   z-50'>
                <div className={`${settingsIsOpen ? `scale-100 ${confirmModalIsOpen ? "" : "right-10"}` : "scale-0 -right-36"} ${confirmModalIsOpen ? " w-full" : ""} transition-all  z-50 top-10 flex flex-col absolute items-start gap-y-3 shadow-xl bg-white p-4 rounded-lg`}>
                  {confirmModalIsOpen || <button className='py-3 bg-slate-100 px-3 text-red-500 font-bold text-sm rounded-lg w-full' onClick={() => setconfirmModalIsOpen(true)}>Hisobdan chiqish</button>}

                  {confirmModalIsOpen &&
                    <div className={`w-full text-center py-4`}>
                      <h2 className='font-bold mb-10'>Hisobdan chiqishga rozimisiz</h2>

                      <button className='py-3 bg-slate-100 px-3 text-red-500 font-bold text-sm rounded-lg w-full' onClick={() => logOut()}>Hisobdan chiqish</button>
                    </div>
                  }
                </div>
              </div>
            ...
            <div className='mb-8'>
              <div className='w-full flex justify-between items-center mb-3'>
                <h2 className='text-lg font-bold'>Tomosha tarixi</h2>
                {/* <button className='py-1 px-3 border-[1px] rounded-3xl text-sm font-bold'>Hammasi</button> */}
              </div>
            ...
            <div>
              <div className='w-full flex justify-between items-center mb-3'>
                <h2 className='text-lg font-bold'>Pleylistlar</h2>
                {/* <button className='py-1 px-3 border-[1px] rounded-3xl text-sm font-bold'>Hammasi</button> */}
              </div>
