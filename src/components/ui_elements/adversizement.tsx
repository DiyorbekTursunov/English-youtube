...
export default function Adversizement() {
    ...
    return (
        <div className='px-3'>
            <div className="bg-[#00425A] max-w-[383px] rounded-[25px] relative mt-[90px] pl-3 w-full mx-auto ad_container mb-[24px]">
                <img src={ad_img} alt="ad img" className='ad_banner absolute right-[24px] bottom-0 w-[194px]' />

                <div className=''>
                    <img src={luca_logo} alt="luca logo" className='ad_wrapper_logo w-[124px] h-[88px] pt-3 mb-2' />
                    <button className='hover:opacity-60 active::opacity-40 ad_wrapper_button' onClick={() => navigate("player/mYfJxlgR2jw")}>
